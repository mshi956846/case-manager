  ...
  return (
    <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-white/10 p-8 shadow-2xl backdrop-blur-xl">
      <div className="mb-6 text-center">
        <div className="mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-2xl bg-white/20 shadow-lg shadow-indigo-500/30 ring-1 ring-white/20 overflow-hidden">
          <Image
        ...
        <h1 className="text-4xl font-bold text-white">Indiana Defender</h1>
